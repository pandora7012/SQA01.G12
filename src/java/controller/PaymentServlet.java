...
public class PaymentServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String account_id_raw = request.getParameter("aid");
        ...
        try {
            ...
            int loan_id = Integer.parseInt(loan_id_raw);
            Loan loan = dao.getLoanByID(loan_id);
            Account account = dao.getAccountByID(account_id);
            Payment payment = dao.getPayment(id);
            BigInteger total_amount = payment.getAmount_per_month().add(payment.getInterest_per_month()).add(payment.getFine());
        ...
        response.sendRedirect("detailbill?id=" + loan_id_raw);
    } 
